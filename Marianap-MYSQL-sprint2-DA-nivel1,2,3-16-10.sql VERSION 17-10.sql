...
-- 2. Es visible que la tabla 'Transaction' tienes las siguientes relaciones:
...
-- EJEMPLO de query para identificar -------------------------------------------------------------
SELECT 
    TABLE_NAME,
    COLUMN_NAME,
    CONSTRAINT_NAME,
...
-- EJEMPLO DE QUERY PARA CONECTAR TODAS LAS TABLAS
SELECT 
    t1.columnA,
    t2.columnB,
    t3.columnC,
...
JOIN table3 AS t3 
    ON t1.columnM = t3.columnN
JOIN table4 AS t4 
    ON t1.columnP = t4.columnQ;
